...
\item[Synchrony.] FROST does not rely on a synchronous network.  \liz{Check partially synchronous.}An adversary may also be \emph{rushing}; that is, it may wait until all honest protocol messages have been sent before determining its own messages.
...
However, FROST does achieve XXX.
