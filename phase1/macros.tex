...
\newcommand{\chenzhi}[1]{ { \color{teal}  Chenzhi: #1 } }
...
\newcommand{\TSUF}[1]{\mathrm{TS}\mbox{-}\mathrm{UF}\mbox{-}{#1}}
\newcommand{\TSSUF}[1]{\mathrm{TS}\mbox{-}\mathrm{SUF}\mbox{-}{#1}}
...
\newcommand{\numParties}{n}
\newcommand{\thresh}{t}
\newcommand{\tcor}{f} % corruption threshold
\newcommand{\corruptedSigners}{\mathrm{CS}}
...
% FROST notation
\newcommand{\bindingfactor}{\rho}
\newcommand{\partyid}{k}
\newcommand{\msg}{m}
\newcommand{\setCommit}{\mathcal{S}_{\rm com}}
