...
\liz{What about authenticated channels between the coordinator and signers?}
...
\item \textbf{Algebraic group model.} \liz{For full adaptive security.}
...
\item \textbf{Schnorr in the AGM paper.} \liz{For full adaptive security.}
...
%Crites, Komlo, Maller, Tessaro, Zhu proved the security of FROST under the algebraic one-more discrete logarithm assumption in the ROM.  This is original to the present submission.
\end{enumerate}
